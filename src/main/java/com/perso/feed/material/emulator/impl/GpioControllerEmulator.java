...
public class GpioControllerEmulator implements GpioController {

	private HashMap<String, GpioPinDigital> pins = new HashMap<>();
	...
	public GpioPinDigitalOutput provisionDigitalOutputPin(Pin pin, String name, PinState defaultState) {
		...
		GpioPinDigitalOutputEmulator digitalPin = new GpioPinDigitalOutputEmulator( pin, defaultState , name );
		this.pins.put( name , digitalPin);
		return digitalPin;
	}
